...
const Discord = require('discord.js')
  let inviteEmbed = new Discord.MessageEmbed()
      ...
      inviteEmbed.setThumbnail(bot.user.displayAvatarURL({ format: "png" }))
      inviteEmbed.setTitle(`Ba Invite Bot Be Servert Azash Hemaiat Kon☺ ${bot.user.username}`)
      ...
      inviteEmbed.setFooter("Created By Mr.SIN RE#1528 :)", 
                            `https://cdn.discordapp.com/attachments/902034619791196221/905054458793312327/2GU.gif`)
